...
const Logo = () => (
  <div className="flex items-center gap-3">
    <div className="relative flex items-center justify-center w-10 h-10 rounded-full bg-blue-600/10 border border-blue-500/30">
      <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-[#1E90FF]">
        <path d="M12 28V12H22C25.3137 12 28 14.6863 28 18C28 20.7645 26.1339 23.1013 23.5742 23.7745L28 28H24L20 24H15.5V28H12ZM15.5 15.5V20.5H22C22.6904 20.5 23.25 19.9404 23.25 19.25C23.25 18.5596 22.6904 18 22 18H19.5V15.5H15.5Z" fill="currentColor"/>
        <circle cx="20" cy="20" r="19" stroke="currentColor" strokeWidth="2" strokeDasharray="4 4" className="opacity-30"/>
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#090a0f] text-[#f3f4f6] selection:bg-[#1E90FF] selection:text-white" style={{ fontFamily: 'Manrope, sans-serif' }}>
      ...
      {/* Navigation */}
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-[#090a0f]/90 backdrop-blur-md border-b border-white/5 py-4' : 'bg-transparent py-6'}`}>
        <div className="container max-w-7xl mx-auto px-6 flex items-center justify-between">
          <a href="#" className="z-50 relative"><Logo /></a>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <img
            ...
            alt="Premium Automotive Lighting"
            className="w-full h-full object-cover object-center scale-105 transform motion-safe:animate-[pulse_20s_ease-in-out_infinite_alternate]"
          />
        </div>
        ...
        <div className="container relative z-20 max-w-7xl mx-auto px-6 text-center md:text-left flex flex-col md:flex-row items-center">
          ...
          >
            <motion.div variants={fadeInUp} className="inline-block mb-4 px-3 py-1 rounded-full border border-[#1E90FF]/30 bg-[#1E90FF]/10 backdrop-blur-sm">
              <span className="text-[#1E90FF] text-xs font-bold tracking-[0.2em] uppercase">Driven By Excellence</span>
            </motion.div>

            <motion.h1 variants={fadeInUp} className="text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight text-white mb-6 leading-[1.1]">
              EXPERT CARE.<br/>
              <span className="text-[#1E90FF]">LASTING<br/>PERFORMANCE.</span>
            </motion.h1>

            <motion.p variants={fadeInUp} className="text-lg md:text-xl text-[#8d939b] font-medium mb-10 max-w-xl mx-auto md:mx-0 leading-relaxed">
            ...
            <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row items-center gap-4 justify-center md:justify-start">
              ...
              <Button href={WA_LINK} primary={false} className="w-full sm:w-auto">
                <MessageCircle className="w-5 h-5 mr-2" />
                Chat on WhatsApp
              </Button>
            </motion.div>

            <motion.div variants={fadeInUp} className="mt-12 flex flex-wrap items-center justify-center md:justify-start gap-6 text-sm font-semibold text-[#8d939b]">
              <div className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-[#1E90FF]" /> Experienced Technicians</div>
              <div className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-[#1E90FF]" /> Quality Parts</div>
              <div className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-[#1E90FF]" /> Reliable Service</div>
            </motion.div>
          </motion.div>
        </div>
      ...
      {/* Trust Strip */}
      <section className="bg-[#12141c] border-y border-white/5 py-12">
      ...
      {/* Services Section */}
      <section id="services" className="py-24 md:py-32 bg-[#090a0f] relative">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#1E90FF]/5 to-transparent pointer-events-none" />
        ...
        <div className="container max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h3 className="text-3xl md:text-5xl font-extrabold text-white mb-6">ENGINEERED FOR EXCELLENCE</h3>
            <div className="h-1 w-20 bg-[#1E90FF] mx-auto rounded-full" />
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              >
                <div className="p-4 rounded-xl bg-[#090a0f] border border-white/5 text-[#1E90FF] group-hover:scale-110 group-hover:bg-[#1E90FF] group-hover:text-white transition-all duration-300 mb-6">
                  {service.icon}
                </div>
      ...
      {/* About Section */}
      <section id="about" className="py-24 bg-[#12141c]">
        <div className="container max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="absolute inset-0 bg-[#1E90FF]/20 group-hover:bg-transparent transition-colors duration-500 z-10 mix-blend-overlay" />
              <img
      ...
      {/* Why Choose Us */}
      <section id="why-us" className="py-24 bg-[#090a0f]">
        <div className="container max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            >
              ...
              <h3 className="text-3xl md:text-4xl font-extrabold text-white mb-6">THE ADVANTAGE OF PRECISION.</h3>
            ...
            <div className="lg:col-span-2 grid sm:grid-cols-2 gap-4">
              {[
                ...
                >
                  <div className="bg-[#1E90FF]/10 p-2 rounded-full text-[#1E90FF]">
      ...
      {/* Process Timeline */}
      <section className="py-24 bg-[#12141c] border-y border-white/5">
        <div className="container max-w-7xl mx-auto px-6">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <h3 className="text-3xl md:text-5xl font-extrabold text-white mb-6">FROM CONTACT TO CONFIDENCE</h3>
            <div className="h-1 w-20 bg-[#1E90FF] mx-auto rounded-full" />
          </motion.div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
            {/* Connecting line on desktop */}
            <div className="hidden lg:block absolute top-12 left-[12.5%] right-[12.5%] h-px bg-gradient-to-r from-transparent via-[#1E90FF]/30 to-transparent" />
            ...
            {[
              ...
              >
                <div className="relative z-10 flex items-center justify-center w-24 h-24 rounded-full bg-[#090a0f] border border-white/10 text-[#1E90FF] group-hover:border-[#1E90FF] group-hover:shadow-[0_0_30px_rgba(30,144,255,0.2)] transition-all duration-300 mb-6">
                  {item.icon}
      ...
      {/* CTA Section */}
      <section className="relative py-32 overflow-hidden bg-[#090a0f]">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#1E90FF]/10 via-transparent to-transparent opacity-60" />
        <div className="absolute inset-0 bg-[linear-gradient(180deg,transparent,rgba(30,144,255,0.04),transparent)]" />
              ...
              <ul className="space-y-5">
                <li>
                  <a href={`tel:+${WA_NUMBER}`} className="flex items-start gap-3 text-[#8d939b] hover:text-[#1E90FF] transition-colors group">
                    <Phone className="w-5 h-5 text-[#1E90FF] mt-0.5 flex-shrink-0" />
                    <div>
                ...
                <li>
                  <a href={`mailto:${EMAIL}`} className="flex items-start gap-3 text-[#8d939b] hover:text-[#1E90FF] transition-colors group">
                    <Mail className="w-5 h-5 text-[#1E90FF] mt-0.5 flex-shrink-0" />
                    <div>
                ...
                <li className="flex items-start gap-3 text-[#8d939b]">
                  <MapPin className="w-5 h-5 text-[#1E90FF] mt-0.5 flex-shrink-0" />
                  <div>
